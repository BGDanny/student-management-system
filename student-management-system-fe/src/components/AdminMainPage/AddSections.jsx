...
export const AddSections = () => {
    ...
    async function submitHandler(e) {
        ...
        const response = await fetch('http://localhost:5000/api/admin/section', {
            ...
            body: JSON.stringify({
                year, semester,instructor,day, location, courseId, startTime, endTime
            }),
        })
    ...
    return <>
        ...
        <div className="form-container">
            <form onSubmit={submitHandler} className="form-section">
                    ...
                    <div>
                    <label>Year: </label>
                    <select type="number" name='Year'  onChange={(e) => setYear(e.target.value)} required> 
                    <option ></option>
                    ...
                    <select type="text" name='Year'  onChange={(e) => setSemester(e.target.value)} required> 
                    <option></option>
                    ...
                    <input type="text" name="instructor" placeholder="Enter Instructor Name"  onChange={(e) => setInstructor(e.target.value)} />
                    </div>
                    <br />
                    <div>
                    <label>Day: </label>
                    <select type="text" name='Weekdays'  onChange={(e) => setDay(e.target.value)} required>
                    <option></option>
                    ...
                    <select type="number" name='courses'  onChange={(e) => setCourse(e.target.value)} required>
                    <option></option>
                    ...
                    <select type="number" name='courses' onChange={(e) => setStartTime(e.target.value)} required>
                    <option></option>
                    ...
                    <select type="number" name='courses' onChange={(e) => setEndTime(e.target.value)} required>
                    <option></option>
                    <option value='8'>8 AM</option>
                    <option value='9'>9 AM</option>
                    <option value='10'>10 AM</option>
