    ...
    return <>
        <div>
            ...
            <form onSubmit={submitHandler} className="form-container">
                ...
                <input type="email" name="eamil" onChange={(e) => setEmail(e.target.value)} required></input>
                </div>
                <br></br>
                <div>
                <label>Letter Grade: </label>
                <select type= "text" id="grades" name="grades" onChange={(e) => setLetterGrade(e.target.value)}>
                ...
                <select type="number" name='courses'  onChange={(e) => setCourseId(e.target.value)} required>
                    <option></option>
                ...
                <br></br>
                <div>
                 <Button type="submit" colorScheme='blue' className="butn">Add Grades</Button>
                </div>
            </form>
            </div>
        </div>
