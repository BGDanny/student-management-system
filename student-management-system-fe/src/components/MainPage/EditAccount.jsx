...
export const EditAccount = () => {
    ...
    return <>
        ...
        <meta className='viewport' content='width=device-width, intial-scale=1'></meta>
       <div className='EditPageBackground'> 
           ...
           <h1 className='EditPageHeading'>Edit Information</h1>
               ...
               <h2><strong>Edit Personal Information:</strong></h2>
               ...
               <br></br>
               <input type="text" id="PhoneNumber" name="PhoneNumber"  placeholder="Phone Number" onChange={(e) => setPhoneNumber(e.target.value)} />
               <br></br>
               <br></br>
             ...
             <br></br>
             <br></br>
<h2><strong>Edit Password:</strong></h2>
               ...
               <input ref={pas1Ref} type="password" id="Password" name="Password"  value={password} placeholder="Password" onChange={(e) => setPassword(e.target.value)}/>
               <br></br>
               <br></br>
               <input ref={pas2Ref} type="password" id="Password" name="Password" value={confPassword} placeholder="Confirm Password" onChange={(e) => setConfPassword(e.target.value)}/>
               <br></br>
               <br></br>
               <button 
                           className ="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"  
