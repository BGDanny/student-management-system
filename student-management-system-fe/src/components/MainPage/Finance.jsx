...
export const Finance = () => {
    ...
    return (
        <>
        {!payShow && <div className="display-tution">
        <h2 className="account-header">Account Summary</h2>
         ...
         {!payShow && <div className="pay-button">
         <Button colorScheme='blue' onClick={payButtonHandler}>Pay Now</Button>
         </div>}
         {!payShow &&<div className="display-loan">
         ...
         {!payShow && <div className="display-payment">
         ...
         {payShow && <div className="form-card-container">
            <div>
                ...
                <div>
                <input type="number" name="Amount" placeholder="Enter Amount" onChange ={(e) => setAmounPaid(e.target.value) } required/>
                </div>
                <div>
                <input  type="text" name="CardNumber" placeholder="Enter Card No" required /> 
                </div>
                <div>
                <input  type="text" name="CardName" placeholder="Enter CardHolder's Name" required /> 
                </div>
                ...
                <div>
                <input type="password" name="cvv" size="2" required /> 
                </div>
                            
                </div>

                <div>
                <Button type="submit" colorScheme='blue'>Pay</Button>
                </div>
                </form>
            </div>
         </div>}
