...
<div>
    <div className="gpa-form">
        ...
        <div className='course1'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits1(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade1(e.target.value)}>
        ...
        <div className='course2'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits2(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade2(e.target.value)}>
            <option value="0"> </option>
            <option value="4.0">A+</option>
            <option value="4.0">A</option>
            <option value="3.70">A-</option>
        ...
        <div className='course2'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits3(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade3(e.target.value)}>
            <option value="0"> </option>
            <option value="4.0">A+</option>
            <option value="4.0">A</option>
            <option value="3.70">A-</option>
        ...
        <div className='course2'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits4(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade4(e.target.value)}>
            <option value="0"> </option>
            <option value="4.0">A+</option>
            <option value="4.0">A</option>
            <option value="3.70">A-</option>
        ...
        <div className='course2'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits5(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade5(e.target.value)}>
            <option value="0"> </option>
            <option value="4.0">A+</option>
            <option value="4.0">A</option>
            <option value="3.70">A-</option>
        ...
        <div className='course2'>
            ...
            <div> 
            <input id='credits' type="number" defaultValue={0} onChange={(e) => setCredits6(e.target.value)}></input>
            </div>
            <div>
            <select id="grades" name="grades" onChange={(e) => setGrade6(e.target.value)}>
            <option value="0"> </option>
            <option value="4.0">A+</option>
            <option value="4.0">A</option>
            <option value="3.70">A-</option>
        ...
        <button type="submit" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Calculate GPA</button>
        </div>
        </form>
        {show && <div>
          <p className='showGPA'>Your GPA is <b>{gpaC}</b></p>       
        </div> }
    </div>
</div>
